...
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_IMIDF;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_IMIDF_ANS;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_IMIVC;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_IMIVC_ANS;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_IRTPTBST;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_IRTPTBST_ANS;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_ISTPTDABST;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_ISTPTDABST_ANS;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_ITVPC;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_ITVPC_ANS_2;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_ITVPC_INFO_1;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_ROBVPIIC;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.ADEST_VFDTAOCST_ANS;
...
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.TSV_ASTPTCT;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.TSV_ASTPTCT_ANS;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.TSV_IBSTAIDOSC;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.TSV_IBSTAIDOSC_ANS;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.TSV_ISCNVABST;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.TSV_ISCNVABST_ANS;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.TSV_WACRABST;
import static eu.europa.esig.dss.validation.policy.rules.MessageTag.TSV_WACRABST_ANS;
...
import static eu.europa.esig.dss.x509.TimestampType.valueOf;
...
public class AdESTValidation extends BasicValidationProcess implements Indication, SubIndication, NodeName, NodeValue, ExceptionMessage {
	...
	// Secondary inputs
	/**
	 * See {@link ProcessParameters#getBvXmlDom()}
	 *
	 * @return
	 */
	...
	private Conclusion process() {
		...
		for (final XmlDom timestampXmlDom : timestampXmlDomList) {
			...
			final TimestampType timestampType = valueOf(timestampTypeString);

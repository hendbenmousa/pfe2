...
import static eu.europa.esig.dss.validation.policy.rules.AttributeValue.*;
...
import static eu.europa.esig.dss.validation.policy.rules.NodeName.STATUS;
import static eu.europa.esig.dss.validation.policy.rules.NodeValue.IGNORED;
import static eu.europa.esig.dss.validation.policy.rules.NodeValue.INFORMATION;
import static eu.europa.esig.dss.validation.policy.rules.NodeValue.KO;
import static eu.europa.esig.dss.validation.policy.rules.NodeValue.WARN;

...
public class SimpleReport extends XmlDom {
	...
	public String getSignatureFormat(final String signatureId) {
		...
		final XmlDom signature = getElement("/SimpleReport/Signature[@Id='%s']", signatureId);
		if (signature != null) {
	...
	public String getValidationPolicyName() {

		final String policyName = getValue("/SimpleReport/Policy/PolicyName/text()");
		return policyName;
	}
}
